...
\newcommand{\titletext}{Exemplarische Prozessgestaltung}
\newcommand{\subtitletext}{Kommunikationsentwicklung}
\newcommand{\authorname}{Michèle Bucher}
\newcommand{\classinfo}{Klasse QR 24.1}
\newcommand{\instituteinfo}{Agogis}
\newcommand{\studyprogram}{2025}
...
\newcommand{\fronttitlefontsize}{27}
\newcommand{\frontsubtitlefontsize}{18}
...
\newcommand{\pagestylefontsize}{11}
...
\fancyhead[L]{%
  \textcolor{pagestylegray}{\fontsize{\pagestylefontsize}{1.2\pagestylefontsize}\selectfont \titletext}
}

% Kopfzeile rechts: \classinfo
\fancyhead[R]{%
  \textcolor{pagestylegray}{\fontsize{\pagestylefontsize}{1.2\pagestylefontsize}\selectfont \classinfo}
}

% Fusszeile links: \authorname
\fancyfoot[L]{%
  \textcolor{pagestylegray}{\fontsize{\pagestylefontsize}{1.2\pagestylefontsize}\selectfont \authorname}
}

% Fusszeile rechts: Seitenzahl / Gesamtseitenzahl
\fancyfoot[R]{%
  \textcolor{pagestylegray}{\fontsize{\pagestylefontsize}{1.2\pagestylefontsize}\selectfont Seite \thepage{} / \pageref{LastPage}}
}
