...
\newcommand{\titletext}{Upgrade eines IPV4-Netzwerks auf Dualstack}
\newcommand{\subtitletext}{IPA 2026}
\newcommand{\authorname}{}
\newcommand{\classinfo}{}
\newcommand{\instituteinfo}{}
...
\addbibresource{sources/quellen.lib} % deine .bib-Datei mit den Quellen
...
\include{journal/aenderungsprotokoll}
\cleardoublepage
\tableofcontents
